...
Scheme
{
	...
	{
		// base colors
		"BaseText"			"192 0 128 255"		// used in text windows, lists
		"BrightBaseText"	"206 10 141 255"	// brightest text
		"SelectedText"		"244 40 143 255"	// selected text
		"DimBaseText"		"244 40 143 255"	// dim base text
		"LabelDimText"		"244 40 143 255"	// used for info text
		"ControlText"		"244 40 143 255"	// used in all text controls
		"BrightControlText"	"244 40 143 255"	// use for selected controls
		"DisabledText1"		"175 3 118 255"		// disabled text
		"DisabledText2"		"0 0 0 0"			// overlay color for disabled text (to give that inset look)
		"DimListText"		"150 0 100 255"		// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"63 58 175 255"		// background color of controls
		...
		"SelectionBG"		"3 18 126 255"		// background color of any selected text or menu item
		"SelectionBG2"		"4 18 130 255"		// selection background in window w/o focus
		"ListBG"			"43 40 85 255"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"			"244 40 143 255"
		"TitleDimText"		"244 40 143 255"
		"TitleBG"			"68 63 175 255"
		"TitleDimBG"		"63 58 175 255"
		...
		// border colors
		"BorderBright"		"75 69 210 255"	// the lit side of a control
		"BorderDark"		"55 51 154 255"		// the dark/unlit side of a control
